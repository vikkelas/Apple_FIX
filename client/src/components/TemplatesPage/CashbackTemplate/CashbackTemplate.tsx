...
const CashbackTemplate = () => {
    return (
        <div className={style.container}>
            ...
            <p><strong>Оформите накопительную карту</strong> Apple Fix и получайте кэшбэк до 10% со следующей покупки! Карта будет удобно храниться в приложение Wallet, где можно отслеживать актуальный статус и баланс. </p>
